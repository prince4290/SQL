...
### 📜 SQL Queries for Filtering and Sorting
...
### Question 1: Show employees working in either the 'IT' or 'HR' departments. [cite: 10]
...
### Question 2: Retrieve employees whose department is in 'Sales', 'IT', or 'Finance'. [cite: 11]
...
### Question 3: Display employees whose salary is between ₹50,000 and ₹70,000. [cite: 12]
...
### Question 4: List employees whose names start with the letter 'A'. [cite: 13]
...
### Question 5: Find employees whose names contain the substring 'an'. [cite: 14]
...
### Question 6: Show employees who are from 'Delhi' or 'Mumbai' and earn more than 55,000. [cite: 15]
...
### Question 7: Display all employees except those from the 'HR' department. [cite: 16]
...
### Question 8: Get all employees hired between 2019 and 2022, ordered by HireDate (oldest first). [cite: 17]
